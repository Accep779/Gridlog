...
class ReportingPeriod(models.Model):
    ...
    def is_current(self):
        ...
        return not self.is_closed and self.start_date <= timezone.now().date() <= self.end_date
...
class Report(models.Model):
    ...
    def can_edit(self):
        ...
        return self.status in [self.Status.NOT_STARTED, self.Status.DRAFT] and not self.period.is_closed
