...
urlpatterns = [
    ...
    path('<int:pk>/approve/', views.ReportViewSet.as_view({'post': 'approve'}), name='report-approve'),
    path('<int:pk>/reject/', views.ReportViewSet.as_view({'post': 'reject'}), name='report-reject'),
